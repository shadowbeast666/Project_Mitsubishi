...
<div id="wrapper">
	...
	<div id="page" class="container">
		<div id="content">
			...
			<div>
                <h2 class="title"><a href="zmiennazwisko">Zmień swoje nazwisko</a></h2><br><br>
				<ul class="style1">
					<li class="first">
                        <form method="post" action="zmiennazwisko">
                        <input type="text" id='pole1' placeholder="Podaj nowe nazwisko" name="pole1">
                            <br><br><br>
                        <input type="text" id='pole2' placeholder="Powtórz swoje nazwisko" name="pole2" disabled>
                            <br><br><br>
                ...
                if(isset($_POST['key'])){
                    ...
                    $nazw = $mysqli->real_escape_string(htmlentities($_POST['pole1']));
                     $chcklogin = mysqli_query($mysqli,"SELECT * FROM `rejestracja` WHERE Login = '$login'");
                    if(mysqli_num_rows($chcklogin) != 0){
                        $sql = "UPDATE `rejestracja` SET `Nazwisko`='$nazw' WHERE Login = '$login'";
                            if($mysqli->query($sql) === true){
                                $_SESSION['zmiananazwiska'] = "Nazwisko zostało zmienione";
                                header("location: welcome?nazwiskotrue");
                        
                            }else{     
                                $_SESSION['niezmiananazwiska'];
                            }
                    }else{
...
<script src="./js/nazwisko.js"></script>
