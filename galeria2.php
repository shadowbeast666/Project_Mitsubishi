	...
	<div id="page" class="container">
		<div id="content">
			...
			<div>
				<ul class="style1">
					<li class="first" >
						<a href="images/g7.jpg"><img id='galery1' src="images/g7.jpg" alt="" width="285" height="165" class="alignleft border" /></a>
                        <a href="images/g8.jpg"><img id='galery2' src="images/g8.jpg" alt="" width="285" height="165"/></a>
					</li>
					<li id='noborder'>
						<a href="images/g9.jpg"><img id='galery1' src="images/g9.jpg" alt="" width="285" height="165" class="alignleft border" /></a>
                        <a href="images/g10.jpg"><img id='galery2' src="images/g10.jpg" alt="" width="285" height="165"/></a>
					</li>
					<li id='noborder'>
						<a href="images/g11.jpg"><img id='galery1' src="images/g11.jpg" alt="" width="285" height="165" class="alignleft border" /></a>
                        <a href="images/g12.jpg"><img id='galery2' src="images/g12.jpg" alt="" width="285" height="165"/></a>
					</li>
                    <li>
                        <a href="galeria"  class="button-style">Poprzednia strona</a> <a href="galerial" id='buttonr' class="button-style">Następna strona</a>
                    </li>
				</ul>
			</div>
		</div>
